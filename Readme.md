...
For now, there has to be only one program entry point `int main` somewhere under the working directory. (in the future, building a library will be supported)
